...
-- Listage de la structure de la base pour lkzh4ikd69snza2f
CREATE DATABASE IF NOT EXISTS `lkzh4ikd69snza2f` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `lkzh4ikd69snza2f`;

-- Listage de la structure de la table lkzh4ikd69snza2f. animal
...
-- Listage des données de la table lkzh4ikd69snza2f.animal : ~9 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. comment_habitat
...
-- Listage des données de la table lkzh4ikd69snza2f.comment_habitat : ~4 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. food_consumption
...
-- Listage des données de la table lkzh4ikd69snza2f.food_consumption : ~4 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. habitat
...
-- Listage des données de la table lkzh4ikd69snza2f.habitat : ~3 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. review
...
-- Listage des données de la table lkzh4ikd69snza2f.review : ~6 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. review_veterinary
...
-- Listage des données de la table lkzh4ikd69snza2f.review_veterinary : ~4 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. service
...
-- Listage des données de la table lkzh4ikd69snza2f.service : ~3 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. user
...
-- Listage des données de la table lkzh4ikd69snza2f.user : ~3 rows (environ)
...
-- Listage de la structure de la table lkzh4ikd69snza2f. zoo
...
-- Listage des données de la table lkzh4ikd69snza2f.zoo : ~0 rows (environ)
