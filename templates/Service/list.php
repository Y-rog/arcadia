...
<main class="container">
    <div class="col-10 mx-auto">
        ...
        <?php foreach ($services as $service) : ?>
            <div class="py-3">
                <h6 class="text-secondary"><?= $service->getTitle(); ?> </h6>
                <ul class="list-group list-group-flush list-group-horizontal">
                    <li class="list-group-item "><?= $service->getDescription(); ?></li>
                ...
                <div class="d-flex justify-content-around pt-2">
                    ...
                    <?php } ?>
                    <?php if (Security::isAdmin()) { ?>
                        <a><button class=" btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteService<?= $service->getId() ?>">Supprimer</button></a>
                        <div class="modal fade" id="deleteService<?= $service->getId() ?>" tabindex="-1" aria-labelledby="addReviewLabel" aria-hidden="true">
